...
public class PostsService {
    ...
    public List<PostsListResponseDto> selectPosts(Long departmentId, int size, Long currentUserId) {
        return queryRepository.findPostsByDepartmentId(departmentId, size, currentUserId);
    }
